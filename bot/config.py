...
class Config(object):
    ...
    AUTH_USERS = get_config("AUTH_USERS", "-1002103913042,2036803347,6015466432")
    ...
    TG_BOT_TOKEN = get_config("TG_BOT_TOKEN", "6617207139:AAFQ_X4wrHGTtLT9O5ZX0UmgA0NagSvCQ4o")
    # the download location, where the HTTP Server runs
    DOWNLOAD_LOCATION = get_config("DOWNLOAD_LOCATION", "/app/downloads")
    # Telegram maximum file upload size
    BOT_USERNAME = get_config("BOT_USERNAME", "AniCoder_01_Bot")
